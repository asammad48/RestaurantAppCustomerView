...
class MockStorage {
  ...
  // Budget Estimates
  async getBudgetEstimate(requestData: any): Promise<any> {
    // Return updated budget estimate response based on the new API format
    return Promise.resolve({
      budgetOptions: [
        {
          totalCost: 620,
          ...
          menuPackages: [
            {
              dealId: 6,
              name: "Pizza Deal",
              description: "Pizza Deal Description",
              price: 1700,
